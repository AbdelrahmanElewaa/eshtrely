    	...
    	<div class="card-header">Sample Product</div>
    		<div class="card-body">
    			<div class="row">
    				...
    				<div class="col-sm-4 text-center">
    					<h3 class="mt-4 mb-3">Rate Here</h3>
  	...
  	<div class="modal-dialog" role="document">
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group text-center mt-4">
	        		<button type="button" class="btn btn-primary" id="save_rating">Submit</button>
	        	</div>
	      	</div>
    	</div>
  	</div>
...
<script>
var product_id = document.getElementById("get").value;
    ...
    $('#save_rating').click(function(){
       ...
       //  {
            $.ajax({
                ...
                method:"POST",
                data:{rating_data:rating_data , ID:product_id},
