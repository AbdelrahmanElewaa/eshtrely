...
$sql= "SELECT  message,createdAt,sender,senderName From messages WHERE sender = '".$_SESSION['id']."' AND receiver =33 OR (sender=33 and receiver = '".$_SESSION['id']."') ORDER BY createdAt asc";
    ...
    for($i=0;$i<$rows;$i++)
    {
        ...
        $senderMessages= mysqli_fetch_array($result); 
          ...
          if($senderMessages[2]==0 || $senderMessages[2]== $_SESSION['id']  )
          {
            ...
            echo"<td ><b>".$senderMessages[3]."(Auditor)</b></td>";
            echo"<td>".$senderMessages[0]."</td>";
            echo"<td>".$senderMessages[1]."</td>";
          }
