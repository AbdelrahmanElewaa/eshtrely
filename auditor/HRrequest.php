...
$sql= "SELECT  message,createdAt,sender,senderName From messages WHERE sender = '".$_SESSION['id']."' AND receiver =43 OR (sender=43 and receiver = '".$_SESSION['id']."') ORDER BY createdAt asc";
