...
$sql= "SELECT  message,createdAt,sender,senderName From messages WHERE sender = '".$_SESSION['id']."' AND receiver =44 OR (sender=44 and receiver = '".$_SESSION['id']."') ORDER BY createdAt asc";
